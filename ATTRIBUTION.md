...
- **Enclosure:** independent CatBadge case development, published by `netmana808`. The versioned releases retain the local project's source, geometry, measured constraints and validation artifacts.
