...
def main():
 ...
 d.text((40,25),'V8.4 / INTEGRAL SNAP CROSS-SECTION',font=r.font(34,True),fill='#EAF2F5')
 ...
 for i,line in enumerate(['Overlapping rim aligns the halves.','Four shallow catches retain them.','0.30 mm nominal rim gap.','0.25 mm selected trial engagement.','Release notches sit beside catches.','Flex rim outward to disengage.']):
  d.text((995,410+i*46),line,font=r.font(20),fill='#EAF2F5')
 # Point at the integral detent without obscuring its section.
 target=xy((1.1,-.3));d.line([(960,775),(910,775),target],fill='#FFB579',width=3);d.ellipse((target[0]-5,target[1]-5,target[0]+5,target[1]+5),fill='#FFB579')
