"""Actual mesh previews of V8.7. PCB outline is a simplified reference."""
...
def run(mode):
 ...
 if mode in ['front','closed_ears']:
  ...
  title='V8.7 / CLOSED BACK / REINFORCED RIM'
  sub='Default: spring access retained.' if mode=='front' else 'Closed-ear variant: original spring antenna must be absent.'
  footer='Closed rear ear panels / Wider catches / Reinforced tongue / Independent battery cover'
  ...
  if mode=='grip_detail':
   ...
   title='V8.7 / FOUR GRIP LINES PER CHEEK';sub='Actual exported cheek coupon, enlarged.'
   ...
   title='V8.7 / SOFTER BUTTON FACE';sub='Actual exported button, enlarged; flat round top retained.'
   ...
   title='V8.7 / BATTERY-COVER EXTERIOR EDGE';sub='Actual exported edge coupon, enlarged; exterior faces the camera.'
  ...
  title='V8.7 / SLIDE + CLICK BATTERY ACCESS'
  ...
  title='V8.7 / FACEPLATE INNER RIM AND FOUR CATCHES'
  ...
  title='V8.7 / GUARDED BATTERY-COVER LATCH'
  ...
  title='V8.7 / OUTER-EAR REAR ANTENNA PORT'
...
if __name__=='__main__':
 ...
 d.text((35,20),'V8.7 / HANDHELD FINISHING SAMPLES',font=r.font(32,True),fill='#EAF2F5')
 ...
 print('Rendered actual V8.7 mesh previews')
